...
#for fasta_file1, fasta_file2, output_file in zip(fasta_files1, fasta_files2, output_file):
#    process_files(fasta_file1, fasta_file2, output_file)


# Process each pair of files
for fasta_file1_path, fasta_file2_path, output_file in zip(fasta_files1, fasta_files2, output_file):

...
plt.title('Riboseq CX5461 Vs TGFb up Frequency Sum vs Log OR')
...
plt.savefig("Riboseq_CX5461_Vs_TGFb_up_dot_plot_with_lines.png")

print("The dot plot with lines has been saved as Ribisqe_CX5461_Vs_TGFb_up_dot_plot_with_lines.png")
...
with open("Riboseq_CX5461_Vs_TGFb_up_codon_log_odds_results.txt", "w") as f:
